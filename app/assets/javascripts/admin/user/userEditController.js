angular.module("admin-app").controller("UserEditController", UserEditController);

UserEditController.$inject = ['$scope', '$stateParams', '$q', 'urls', 'CookieService', 'HttpRequest', 'validators', 'toastr'];

function UserEditController($scope, $stateParams, $q, urls, CookieService, HttpRequest, validators, toastr) {
